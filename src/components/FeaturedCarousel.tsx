...
const products = [
  {
    id: 1,
    name: "Canyon Number 001",
    price: "$185.00",
    image:
      "https://images.unsplash.com/photo-1549298916-b41d501d3772?q=80&w=2012&auto=compress&fit=crop",
  },
  {
    id: 2,
    name: "Frontier Turf Olive",
    price: "$195.00",
    image:
      "https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?q=80&w=1974&auto=compress&fit=crop",
  },
  {
    id: 3,
    name: "Eagle Sun Yellow",
    price: "$175.00",
    image:
      "https://images.unsplash.com/photo-1560769629-975e13f0c470?q=80&w=1974&auto=compress&fit=crop",
  },
  {
    id: 4,
    name: "Dakota Heritage",
    price: "$210.00",
    image:
      "https://images.unsplash.com/photo-1525966222134-fcfa99b8ae77?q=80&w=1998&auto=compress&fit=crop",
  },
  {
    id: 5,
    name: "Canyon Runner Red",
    price: "$165.00",
    image:
      "https://images.unsplash.com/photo-1562183241-b937e95585b6?q=80&w=1965&auto=compress&fit=crop",
  },
];
  ...
  return (
    <div className="bg-heritage-bone py-16 border-b border-heritage-charcoal/5 overflow-hidden">
      <div className="max-w-[1600px] mx-auto px-6 mb-10 flex items-end justify-between">
        ...
        <a
          href="#"
          className="text-xs font-bold uppercase tracking-widest text-heritage-clay hover:text-heritage-brown transition-colors"
        >
          View Collection
        </a>
      </div>
