      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-20">
          ...
          <div className="md:col-span-5 space-y-8">
            ...
            <p className="text-sm text-heritage-charcoal/60 max-w-sm leading-relaxed">
              Built with the community. Shared with the community. First access,
              always. Crafted for the culture, rooted in the land.
            </p>
          ...
          <div className="md:col-span-6 grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              <h4 className="font-bold text-sm uppercase tracking-widest text-heritage-charcoal">
                Shop
              </h4>
              <ul className="space-y-3 text-sm text-heritage-charcoal/70">
                <li>
                  <a
                    href="#"
                    className="hover:text-heritage-clay transition-colors"
                  >
                    Shop All
                  </a>
                </li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 text-xs text-heritage-charcoal/60">
          <div className="flex flex-col md:flex-row gap-4 md:gap-8">
            <div>
              ...
              <a
                href="mailto:hello@kanien.com"
                className="hover:text-heritage-clay underline decoration-1 underline-offset-2"
              >
                hello@kanien.com
              </a>
            </div>
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="hover:text-heritage-clay transition-colors">
        ...
        <div className="mt-12 text-center">
          <p className="text-[10px] uppercase tracking-widest text-heritage-charcoal/40">
            © {new Date().getFullYear()} Kanien. All rights reserved. Made for
            USA.
          </p>
        </div>
      </div>
