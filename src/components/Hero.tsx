...
export const Hero = () => {
  ...
  return (
    <div
      ref={ref}
      className="relative h-screen w-full overflow-hidden bg-heritage-bone"
    >
      {/* LAYER 1: Background */}
      <motion.div
        style={{ y: yBg }}
      ...
      >
        ...
        <img
          src="https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/sneakers/Gemini_Generated_Image_mjsivzmjsivzmjsi.webp"
      ...
      <div className="relative z-20 h-full w-full flex flex-col items-center justify-start pt-[30px] pb-0">
        ...
        >
          <span className="text-heritage-bone/90 md:text-heritage-charcoal font-bold tracking-[0.3em] text-[10px] md:text-xs uppercase mb-6 drop-shadow-sm md:drop-shadow-none">
            Est. {new Date().getFullYear()} • Native American Heritage
          </span>
        ...
        >
          <img
            src="https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/sneakers/Gemini_Generated_Image_mjsivzmjsivzmjsia.webp"
