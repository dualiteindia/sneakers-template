    ...
    <section className="bg-heritage-bone py-16 md:py-24 border-b border-heritage-charcoal/5">
      <div className="max-w-[1800px] mx-auto px-6 md:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
          ...
          <a
            href="#"
            className="hidden md:flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-heritage-clay hover:text-heritage-brown transition-colors"
          >
        ...
        <div className="mt-8 md:hidden flex justify-center">
          <a
            href="#"
            className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-heritage-clay hover:text-heritage-brown transition-colors"
          >
            View Collection <ArrowRight className="w-4 h-4" />
          </a>
        </div>
