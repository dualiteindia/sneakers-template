...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    productImage:
      "https://images.unsplash.com/photo-1603808033192-082d6919d3e1?q=80&w=2115&auto=compress&fit=crop",
  },
];
      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xs text-heritage-charcoal/60 mt-2 font-medium">
            from 256 reviews{" "}
            <BadgeCheck className="w-3 h-3 inline text-heritage-clay ml-1" />
          </p>
        </div>
